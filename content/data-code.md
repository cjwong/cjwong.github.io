...
- [Survey mapping code](https://github.com/bowers-illinois-edu/community-maps) used to collect hand-drawn maps in the Mapping Local Communities Canada Survey.
- [YouGov mapping code](https://github.com/cwong-lab/bes-mapping) used in the British Election Study (2015) and Comparative Congressional Election Studies (2014, 2016).

## Boundaries of Obligation in American Politics
- [Supplementary tables](http://github.com/cwong-lab/boundaries-of-obligation) for the book.
